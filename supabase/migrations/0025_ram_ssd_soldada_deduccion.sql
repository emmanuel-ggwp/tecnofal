-- Migración 0025 (espejo de nhost 1751900000024): RAM/SSD soldada dejan de bloquear la puja —
-- pasan a advertencia + deducción automática de $20 en el panel (ver packages/core parser.ts/eval.ts).
